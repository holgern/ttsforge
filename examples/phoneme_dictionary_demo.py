...
# Create conversion options with phoneme dictionary
options = ConversionOptions(
    voice="af_bella",
    language="a",
    speed=1.0,
    output_format="wav",
    phoneme_dictionary_path=str(dict_path),
)
...
output_path = Path(__file__).parent.parent / "phoneme_dictionary_demo.wav"
result = converter.convert_text(test_text, output_path)
...
3. Test your phonemes with 'ttsforge sample' before converting a whole book
