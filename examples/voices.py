#!/usr/bin/env python3
"""
Voice mixing/blending demonstration using ttsforge.
...
def main():
    ...
    for i, (description, blend_str, single_voice) in enumerate(demos, 1):
        ...
        announcement_audio, _ = kokoro.create(
            announcement_text,
            voice="af_sarah",
            speed=1.0,
            lang="en-us",
    ...
    conclusion_audio, _ = kokoro.create(
        conclusion_text,
        voice="af_sarah",
        speed=1.0,
        lang="en-us",
    ...
    print("  ttsforge sample 'Hello world' --voice 'af_sarah:50,am_michael:50'")
